const parse = async (demo) => {
    ...
    fs.readFile(demo, (err, buffer) => {
        const demoFile = new demofile.DemoFile();

        /* Parsujeme začiatok dema */
        /* Zistujeme základne info o zápase */
        demoFile.on("start", () => {
            match = new Match(demo, demoFile.header.mapName, demoFile.header.playbackTime, demoFile.header.serverName, demoFile.header.clientName, demoFile.tickRate)
